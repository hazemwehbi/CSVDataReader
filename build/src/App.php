...
use Hazem\CSVDataUploader\Console\Console;
use Hazem\CSVDataUploader\Console\ConsoleInterface;
use Hazem\CSVDataUploader\Console\InputInterface;
use Hazem\CSVDataUploader\Console\OptionDefinition;
use Hazem\CSVDataUploader\Console\OutputInterface;
...
final class App
{
    ...
    private function uploadUsersCommand(OutputInterface $output, InputInterface $input): void
    {
        ...
        $output->writeln('* Processed successfully:' . $result->getProcessed());
        $output->writeln('* Inserted to DB: ' . $result->getInserted());
